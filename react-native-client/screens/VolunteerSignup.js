...
const VolunteerSignup = () => {
    ...
    const sendDataToServer = async (username, password, email, firstname, lastname, city) => {
        try {
            const apiUrl = 'https://4ded-49-248-167-18.ngrok-free.app/api/register/volunteer';
            ...
            <SafeAreaView style={{ paddingRight: 20, paddingLeft: 20, paddingTop: 10, flex: 1, paddingBottom: 160 }}>
                ...
                <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flex: 1 }}>
                    <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: 130 }}>
                        <Text style={{ fontSize: 30 }}>VolunteerSignup</Text>
                        ...
                        <TouchableOpacity style={{ marginTop: 10 }} onPress={() => navigation.navigate('VolunteerLogin')}>
                            <View style={{
                                width: 200,
                                height: 50,
                                borderRadius: 15,
