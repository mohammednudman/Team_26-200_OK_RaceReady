  ...
  return (
   ...
   {/* return ( */}
     <div>
       ...
       <p>Enter the registration fees for the event</p><input type="text" placeholder="Fees" style={inputStyle} />
       ...
       <p>Enter the name of the sponsor who is going to sponsor the event</p><input type="text" placeholder="Sponsor" style={inputStyle} />
