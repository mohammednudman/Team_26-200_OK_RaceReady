...
const Calender = () => {
    ...
    return (
        <div style={{padding: '20px'}}>
            ...
            {/* return ( */}
            <div>
                <b><p>Enter the title of the event</p><input type="text" placeholder="Title" style={inputStyle}
                                                             onChange={(e) => handleInputChange('eventName', e.target.value)}/></b>
                <b><p>Enter the description of the event</p><input type="text" placeholder="Title" style={inputStyle}
                                                                   onChange={(e) => handleInputChange('description', e.target.value)}/></b>
                <b><p>Enter the registration fees for the event</p><input type="text" placeholder="Fees"
                                                                          style={inputStyle}
                                                                          onChange={(e) => handleInputChange('fees', e.target.value)}/></b>
                <b><p>Enter the registration deadline for the event</p><input type="date" placeholder="Fees"
                                                                              style={inputStyle}
                                                                              onChange={(e) => handleInputChange('registrationDeadline', e.target.value)}/></b>
                <b><p>Enter the date of the event</p><input type="date" style={inputStyle}
                                                            onChange={(e) => handleInputChange('eventDate', e.target.value)}/></b>
                <b><p>Enter the city where the event</p><input type="text" placeholder="City" style={inputStyle}
                                                               onChange={(e) => handleInputChange('city', e.target.value)}/></b>
                <b><p>Enter the place where the event</p><input type="text" placeholder="Place" style={inputStyle}
                                                                onChange={(e) => handleInputChange('place', e.target.value)}/></b>
                <b><p>Enter the name of the sponsor who is going to sponsor the event</p><input type="text"
                                                                                                placeholder="Sponsor"
                                                                                                style={inputStyle}
                                                                                                onChange={(e) => handleInputChange('sponsors', e.target.value)}/></b>
                <b><p>Enter the name of the organizer who is going to organize the event</p><input type="text"
                                                                                                   placeholder="Sponsor"
                                                                                                   style={inputStyle}
                                                                                                   onChange={(e) => handleInputChange('organizer', e.target.value)}/></b>
            ...
            <div>
                ...
                <label>
                    <input
                        type="checkbox"
                        checked={marathonType['42']}
                        onChange={() => handleCheckboxChange('42')}
                    />
                    42km
                </label>
            </div>
